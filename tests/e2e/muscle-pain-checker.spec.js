...
const SVC_URL = "https://appadaycreator.com/muscle-pain-checker/";
const SVC_NAME = "筋肉痛・部位別ケアアドバイザー";

test.describe("筋肉痛・部位別ケアアドバイザー - E2Eテスト", () => {
  ...
  test("ページ基本: タイトル・h1・canonical", async ({ page }) => {
    ...
    expect(canonical).toContain("muscle-pain-checker");
